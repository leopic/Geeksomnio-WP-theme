        ...
        <div class="slideshow"><div id="slideshow">
			...
			<div class="slide clear">
				<div class="post">
					...
					<div class="post-meta">por <span class="post-author"><a href="<?php echo get_author_posts_url( get_the_author_meta( 'ID' ) ); ?>" title="Posts by <?php the_author(); ?>"><?php the_author(); ?></a></span> on <span
